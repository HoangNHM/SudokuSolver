...
/**
 * Created by vantuegia on 11/14/2015.
 */
public class PublishSolution {
    ...
    private static void saveBmpToFile(Context context, Bitmap bmp) {
        try {
            ...
            FileOutputStream stream = new FileOutputStream(cachePath + "/solution.png"); // overwrites this image every time
    ...
    private static Uri getUri(Context context) {
        ...
        File newFile = new File(imagePath, "solution.png");
        Uri contentUri = FileProvider.getUriForFile(context, "com.hoangnhm.sodukusolver.fileprovider", newFile);
        return contentUri;
    }
